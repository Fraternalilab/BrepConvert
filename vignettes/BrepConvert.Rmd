...
chicken_IgL_gene_order <- as.numeric(gene_order_table[, "IMGT.locus.gene.order"]) # force these into numbers
names(chicken_IgL_gene_order) <- gene_order_table[, "IMGT.gene.name"]
```
